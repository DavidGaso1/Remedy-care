      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300 leading-relaxed max-w-2xl mx-auto">
            Advanced Natural Remedy is dedicated to providing science-backed, NAFDAC-approved natural solutions 
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-dark dark:text-white mb-4">
              Why Choose <span className="text-gradient">Advanced Natural Remedy</span>
            </h2>
